...
public class Matrix3x3 {
	...
	public static Matrix3x3 identity
	{
		get
		{
			...
			i.SetRow(0, new Vector3(1.0f, 1.0f, 0.0f));
	...
	public static Matrix3x3 operator *(Matrix3x3 b, Matrix3x3 c)
	{
		...
		for (int i = 0; i < matrixOrder; i++)
		{
			Vector3 r = new Vector3(b[i, 0] * c[0, 0] + b[i, 1] * c[1, 0] + b[i, 2] * c[2, 0],
    ...
    // Test the equality of this amtrix and another
